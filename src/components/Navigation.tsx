      ...
      >
        <div className="max-w-7xl mx-auto px-8 lg:px-16 flex items-center justify-between">
          ...
          <a
            ...
            className="text-h6 font-medium text-white hover:text-[#C9A84C] transition-colors duration-300"
          >
        ...
        <div className="flex flex-col items-center justify-center h-full gap-8">
          {navigationConfig.items.map((item, i) => (
            <a
              ...
              href={item.href}
              onClick={(e) => handleNavClick(e, item.href)}
              className="text-h3 text-white hover:text-[#C9A84C] transition-colors duration-300"
              style={{
