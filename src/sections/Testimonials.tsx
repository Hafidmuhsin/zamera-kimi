...
export function Testimonials() {
  ...
  useEffect(() => {
    ...
    if (!section || !testimonialsConfig.title || testimonialsConfig.testimonials.length === 0) return;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {testimonialsConfig.testimonials.map((testimonial, index) => (
            <div
              ...
              className="relative bg-[#F5F0E8]/5 backdrop-blur-md p-8 lg:p-10 group hover:bg-[#F5F0E8]/10 transition-colors duration-300 preserve-3d rounded-none border border-[#F5F0E8]/10"
              style={{
            ...
            >
              ...
              {/* Quote text */}
              <p className="text-body-lg text-[#F5F0E8]/80 leading-relaxed mb-8 relative z-10 font-jost italic">
                "{testimonial.quote}"
              </p>
              ...
              <div className="flex items-center gap-4">
                {/* Avatar */}
                <div className="avatar w-14 h-14 rounded-none overflow-hidden border-2 border-[#C9A84C]/30 flex-shrink-0">
                  <img
                ...
                {/* Info */}
                <div>
                  <h4 className="text-body text-[#F5F0E8] font-medium font-cinzel text-xs tracking-widest uppercase">
                    {testimonial.name}
                  </h4>
                  <p className="text-body-sm text-[#F5F0E8]/50 font-jost text-xs mt-1">
                    {testimonial.title}
                  </p>
                </div>
              </div>
