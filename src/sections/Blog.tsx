...
export function Blog() {
  ...
  useEffect(() => {
    ...
    if (!section || !blogConfig.title || blogConfig.posts.length === 0) return;
          ...
          {blogConfig.posts.map((post, index) => (
            ...
            >
              ...
              <div className="post-content">
                ...
                {/* Title */}
                <h3 className="text-h4 lg:text-h3 text-white font-medium mb-3 group-hover:text-[#C9A84C] transition-colors duration-300 relative">
                  {post.title}
                  <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#C9A84C] group-hover:w-full transition-all duration-300" />
                </h3>
