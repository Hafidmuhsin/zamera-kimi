...
export function Works() {
  ...
  const titleChars = useMemo(
    () => (worksConfig.title ? worksConfig.title.split('') : []),
    []
  );

  useEffect(() => {
    const section = sectionRef.current;
    if (!section || !worksConfig.title || worksConfig.projects.length === 0) return;
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto mb-16">
        <h2
          ref={titleRef}
          className="text-h1 lg:text-display-xl text-[#F5F0E8] font-medium mb-6 font-cinzel"
        >
            ...
            >
              ...
              <div className="relative aspect-[3/4] overflow-hidden bg-dark-gray">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 lg:p-8">
                  <p className="text-body-sm text-white/60 mb-2 group-hover:text-[#C9A84C] transition-colors duration-300">
                    {project.category}
                  </p>
                ...
                <div className="absolute top-6 right-6">
                  <div className="w-12 h-12 rounded-none bg-white/10 backdrop-blur-sm flex items-center justify-center group-hover:bg-[#C9A84C] group-hover:scale-110 transition-all duration-500 border border-white/20 group-hover:border-transparent">
      ...
      {/* Decorative elements */}
      <div className="absolute top-20 left-0 w-32 h-32 bg-[#C9A84C]/5 -translate-x-1/2" />
