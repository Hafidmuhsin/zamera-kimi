...
export function Footer() {
  ...
  useEffect(() => {
    ...
    if (!section || !footerConfig.copyright) return;
                  ...
                  <span
                    ...
                    className={
                      highlightChars.includes(char)
                        ? 'text-[#C9A84C] animate-pulse-glow'
                        : 'text-white'
                    }
                    style={
                      highlightChars.includes(char)
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="col-span-2 lg:text-right">
            <a
              ...
              className="inline-flex items-center gap-3 text-h5 lg:text-h4 text-white font-medium group hover:text-[#C9A84C] transition-colors duration-300"
            >
              {footerConfig.ctaText}
              <span className="w-10 h-10 rounded-full border border-white/30 flex items-center justify-center group-hover:border-[#C9A84C] group-hover:shadow-[0_0_15px_rgba(201,168,76,0.4)] transition-all duration-300">
